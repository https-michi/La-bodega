//
//  PerfilCustomerViewController.swift
//  LaBodega
//
//  Created by DISEÑO on 10/05/25.
//
...
class PerfilCustomerViewController: BaseViewController, UITextFieldDelegate {
    ...
    let viewModel = PerfilCustomerViewModel()
